...
namespace UI
{
    public class CDate : Calendar
    {
        ...
        public string GetPersianDate(string strDate, bool InputWithSladh, bool OutputWithSlash)
        {
            ...
            d = Convert.ToDateTime(strDate.ToString());
            //try
            //{
                ...
                if (InputWithSladh)
                {
                    ...
                    //DateTime x=Convert.ToDateTime(strDate.Substring(0, 4));
                    //nYear = x.;
                    nYear = Convert.ToInt32(d.Year);
                    nMonth = Convert.ToInt32(d.Month);
                    nDay = Convert.ToInt32(d.Day);
        ...
        public string GetMiladiDate(string strDate, bool InputWithSladh, bool OutputWithSlash)
        {
            ...
            if (InputWithSladh)
            {
                ...
                Year = Convert.ToInt32(d.Year);
                Month = Convert.ToInt32(d.Month);
                Day = Convert.ToInt32(d.Day);
