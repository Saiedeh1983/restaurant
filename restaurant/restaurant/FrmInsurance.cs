...
namespace restaurant
{
    public partial class FrmInsurance : Form
    {
        ...
        private void btnfind_Click(object sender, EventArgs e)
        {
            ...
            CarID = c.CarID;
            // Fillnumlastsalary();
            DataTable dtInsuranceList = dalin.LoadInsuranceList(CarID);
            gridIncreasesalary.DataSource = dtInsuranceList;
            gridMaker();
        ...
        private void FillControl(Insurance insurance)
        {
            id = insurance.InsuranceID;
            CarID = insurance.CarID;
            numamount.Value = Convert.ToDecimal(insurance.amount);
            txtDate.Text = insurance.Date.Trim();
            txtExpireDate.Text = insurance.ExpireDate;
            txtDesc.Text = insurance.Desc;
        ...
        private Insurance LoadControls()
        {
            ...
            insurance.amount = Convert.ToInt32(numamount.Value);
            insurance.Date = txtDate.Text.Trim();
            insurance.ExpireDate = txtExpireDate.Text;
            insurance.Desc = txtDesc.Text;
        ...
        private void LoadUC()
        {
            DataTable dtpersonList = dalin.LoadInsuranceList(CarID);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (CarID != 0)
                ...
                {
                    bool Test = dalin.InsertInsurance(insurance);
                    if (Test == false)
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult dlr;
                dlr = MessageBox.Show("آیا بیمه مورد نظر حذف شود" + "؟", "Question", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (dlr == DialogResult.Yes)
                {
                    if (insurance != null)
                    {
                        dalin.DeleteInsurance(insurance.InsuranceID, userID);
        ...
        {
            List<Insurance> LHpl = dalin.LoadInsuranceListWithDistinctCarID(userID);
            Insurance hc = new Insurance();
            for (int l = 0; LHpl.Count > l; l++)
            {
                hc.CarID = LHpl[l].CarID;
                List<Insurance> lh2 = dalin.LoadInsuranceList3(LHpl[l].CarID);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataTable dtpersonListe = dalin.LoadInsuranceListFORExcel(userID);
